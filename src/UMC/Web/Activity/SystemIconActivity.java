...
class SystemIconActivity extends WebActivity {


    public void processActivity(UMC.Web.WebRequest request, UMC.Web.WebResponse response) {
        ...
        int UserId = Utility.parse(this.asyncDialog("Icon", g ->
        {
            ...
            if (ui.length() == 0) {
                ui.put("Desc", new UMC.Web.WebMeta().put("desc", "未搜索到图标").put("icon", "\uEA05")
        ...
        ListItem item = new ListItem(iconNames[UserId], icons[UserId]);
