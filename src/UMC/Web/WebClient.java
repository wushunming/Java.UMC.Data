...
public class WebClient {
    ...
    public WebClient(WebSession session, URI uri, URI referrer, String UserAgent, String ip) {
        ...
        if (UMC.Data.Utility.isEmpty(header) == false) {
            ...
            if (this.InnerHeaders.containsKey("Click")) {
                this.UIEvent = JSON.deserialize((String) this.InnerHeaders.get("Click"), UIClick.class);
    ...
    void ClearUIEvent(String model, String cmd) {
        if (this.UIEvent != null) {
            ...
            if (model.equals(this.InnerHeaders.get("POS-MODEL")) == false || cmd.equals(this.InnerHeaders.get("POS-COMMAND")) == false) {
    ...
    public void WriteTo(Writer writer, IWebRedirect redirect, boolean ismore) throws IOException {
        ...
        if (this.UIEvent != null) {
            this.InnerHeaders.put("Click", JSON.serialize(this.UIEvent));
        }
        Map<String, Object> map = null;
        if ((this.ClientEvent & WebEvent.ASYNCDIALOG) == WebEvent.ASYNCDIALOG || this._isSave) {
            this.session.storage(this.InnerHeaders, context);
        }
        if (context != null)
