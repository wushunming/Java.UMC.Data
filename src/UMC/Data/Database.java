...
public final class Database {
     ...
     * 创建默认数据库实体访实例
     *
     * @param providerName 配置节点名,在App_Data/UMC/database.xml中配置
     * @return
     */
    public static Database instance(String providerName) throws RuntimeException {
        ProviderConfiguration configuration = ProviderConfiguration.configuration("database");
        if (configuration == null) {
            throw new SetupException();
        }
        Provider provider = configuration.get(providerName);
