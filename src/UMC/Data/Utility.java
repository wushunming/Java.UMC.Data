...
public class Utility {
    ...
    // 调用http接口获取数据
    public static String httpString(String path) {
...
//            connection.connect();
    ...
    public static void setField(Object obj, Map<String, Object> dic) {
        ...
        for (int i = 0; i < pros.length; i++) {
            Field field = pros[i];
            if (dic.containsKey(field.getName())) {
    ...
    public static void copy(InputStream input, OutputStream outputStream) {
        try {
...
//        f.compile();f.
    ...
    public static boolean isEmpty(UUID uuid) {
        ...
        return uuid.compareTo(uuidEmpty) == 0;
    }
