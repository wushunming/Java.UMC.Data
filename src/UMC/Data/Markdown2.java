...
//
//
//    public static UICell highlight(String code,String type) {
//        return  new Highlighter().Transform(code);
//
//    }
//
//    public static UICell[] transform(String text) {
//        Markdown2 markdown = new Markdown2();
...
//
//                        cells.add(cell);//new Highlighter().Transform(content));
//                        index = text.indexOf('\n', end + 1) + 1;
//                        check(text, index);
//                        return;
//                    }
